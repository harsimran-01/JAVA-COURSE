...
public class Plannerguip extends JFrame {
    int totalIncome = 0;
    ...
    int result = JOptionPane.showConfirmDialog(null, panel, "🔐 Login to Planner", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
    ...
    if (result == JOptionPane.OK_OPTION) {
        ...
        if (user.equals("admin") && pass.equals("pass123")) {
            ...
            return showLoginDialog();  // Optionally retry login
        }
    }
    return false;
}
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            Plannerguip app = new Plannerguip();
