...
System.out.println("Date: " + date); 
    ...
    static void viewReport() {
        ...
        System.out.println("Actual Savings   : ₹" + savings + (savings >= savingsGoal ? " ✅ (Goal achieved!)" : " ❌ (Below goal)"));
    }
    ...
    static void predictStatus() {
        ...
        if (totalExpenses <= totalIncome) {
            ...
            System.out.println("Status: ❌ Over Budget! Consider reviewing expenses.");
        }
...
sc.nextLine();
    ...
    String status = spent == 0
        ? "✅ Not Used Yet"
        : (spent < budget ? "✅ Under Budget" : (spent == budget ? "⚠️ At Limit" : "❌ Over Limit"));
    ...
    //     System.out.println("\n🎯 Set/Check Savings Goal");
    //     int totalSpent = expenses.stream().mapToInt(e -> e.amount).sum();
    //     int actualSavings = totalIncome - totalSpent;
    //     System.out.println("Current Savings Goal: ₹" + savingsGoal);
    //     System.out.println("Actual Savings: ₹" + actualSavings);
    //     if (actualSavings >= savingsGoal) {
    //         System.out.println("\n✅ You're exceeding your savings goal by ₹" + (actualSavings - savingsGoal) + "!\nWell done!\n");
    //     } else {
    //         System.out.println("\n❌ You are ₹" + (savingsGoal - actualSavings) + " short of your goal.\nKeep saving!\n");
    //     }
    // }
